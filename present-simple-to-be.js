// Perguntas sobre Present Simple - To Be em Inglês
const questions = [
    {
        question: "I _____ happy.",
        type: "Present Simple - To Be - Affirmative",
        answers: [
    ...
    {
        question: "_____ you ready?",
        type: "Present Simple - To Be - Interrogative",
        answers: [
            { label: "A", text: "Am" },
            { label: "B", text: "Is" },
            { label: "C", text: "Are", correct: true },
    ...
    {
        question: "I _____ six years old.",
        type: "Present Simple - To Be - Affirmative",
        answers: [
            { label: "A", text: "am", correct: true },
            { label: "B", text: "is" },
    ...
    {
        question: "_____ he your brother?",
        type: "Present Simple - To Be - Interrogative",
        answers: [
            { label: "A", text: "Am" },
            { label: "B", text: "Is", correct: true },
    ...
    {
        question: "We _____ happy together.",
        type: "Present Simple - To Be - Affirmative",
        answers: [
            { label: "A", text: "am" },
            { label: "B", text: "is" },
    ...
    {
        question: "The book _____ interesting.",
        type: "Present Simple - To Be - Affirmative",
        answers: [
            { label: "A", text: "am" },
            { label: "B", text: "is", correct: true },
...
const RANKING_KEY = 'presentSimpleToBeRanking';
...
function initGame() {
    ...
    if (playerGreeting) {
        playerGreeting.textContent = `Hello ${PLAYER_NAME}! Learn the verb 'to be' in English!`;
    }
